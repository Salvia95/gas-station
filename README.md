...
때문에, 이런 문제를 해결하고자 **비동기 이벤트 통신 방식을 적용**하고자 하였으며, RabbitMQ나 Kafka와 같은 **이벤트 큐/스트리밍을 사용하기 위한 인프라의 구성이 불가**하고, **SAGA 패턴을 적용할 정도의 기술적 성숙도가 되지 않는다 판단**하여 **`Application Context` 기반 이벤트 통신을 적용**하였습니다. 
